...
function runGame() {
    ...
    message_area.innerHTML+= "Choose your pokemon! <br />";
    message_area.innerHTML+= "***** <br />";
    ...
    } else if (players_choice == 'charmander') {
        checkComputerWins('squirtle', 'splashes', 'burns');
    } else if (players_choice == 'squirtle') {
        checkComputerWins('bulbasaur', 'cuts', 'splashes');
    } else if (players_choice == 'bulbasaur') {
        checkComputerWins('charmander', 'burns', 'cuts');
    } else {
